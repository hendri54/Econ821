...
if ~isempty(nameV)
   if ischar(nameV)
      nameV = {'+distrib_lh/cdf_weighted', '+distrib_lh/cdf_lh', '+distrib_lh/pcnt_weighted',  '+distrib_lh/gini_weighted',  ...
         ...
         '+stats_lh/std_w', ...
         '+t_distrib_lh/t_cdf_lh', '+t_distrib_lh/t_pcnt_weighted', '+t_distrib_lh/t_norm_grid_lh', ...
